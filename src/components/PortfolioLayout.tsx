...
import { VideoControlProvider, useVideoControls } from "./VideoControlProvider";
...
const PortfolioContent: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    switch (currentSection) {
      case "home":
        return <HomeSection onNavigateToProjects={() => handleMenuClick("projects")} />;
      case "projects":
        return (
          <ProjectsSection
  ...
  return (
    <div className="min-h-screen bg-black text-foreground overflow-x-hidden">
      ...
      {/* Main Content Area */}
      <div className={`relative z-10 content-area ${!isInnerPage ? "lg:ml-sidebar" : ""}`}>
...
const NavigationMenu: React.FC<NavigationMenuProps> = ({ isOpen, currentSection, onMenuClick }) => (
  <nav
...
const AdditionalSection: React.FC<{ onBack: () => void }> = ({ onBack }) => (
  <div className="max-w-4xl mx-auto">
    <button onClick={onBack} className="mb-8 flex items-center space-x-2 theme-back-button">
