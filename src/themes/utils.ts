 ...
 */
export function colorThemeToCSSProperties(theme: ColorTheme): Record<string, string> {
  ...
  cssProps['--theme-button-hover-border'] = `${theme.colors.primary.main} / 0.8`;
  ...
  cssProps['--theme-content-text-muted'] = `${theme.colors.neutral.foreground} / 0.7`;
  cssProps['--theme-content-text-subtle'] = `${theme.colors.neutral.foreground} / 0.6`;
